...
Executor::fork(ExecutionState &current, ref<Expr> condition, bool isInternal) {
  ...
  if (res==Solver::True) {
    ...
    addConstraint(current, condition, true);
    ...
    addConstraint(current, Expr::createIsZero(condition), true);
...
void Executor::addConstraint(ExecutionState &state, ref<Expr> condition, bool extra) {
